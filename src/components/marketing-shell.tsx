...
import { ShoppingBag, LogIn, Shield } from "lucide-react";
      ...
      <footer className="border-t mt-12">
        <div className="container mx-auto px-4 py-8 text-sm text-muted-foreground flex flex-col md:flex-row justify-between gap-3">
          ...
          <div className="flex gap-4 items-center flex-wrap">
            ...
            <Link to="/login" className="hover:text-primary">دخول الشركات</Link>
            <Link to="/admin/login" className="inline-flex items-center gap-1 opacity-70 hover:opacity-100">
              <Shield className="h-3 w-3" /> مدير المنصة
            </Link>
          </div>
        </div>
      </footer>
